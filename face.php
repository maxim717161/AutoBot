...
<tr><td>Новый?</td>
<td width="10"><input type="checkbox" id="isreg" checked onblur="document.getElementById('email').value=document.getElementById('isreg').value" onchange="if(document.getElementById( 'isreg' ).value){document.getElementById( 'button' ).value='Регистрция'}else{document.getElementById( 'button' ).value='Войти'}"/></td>
