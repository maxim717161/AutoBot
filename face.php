...
<table border="0">
<tr><td colspan="3" align="center"><h6>Вход / Регистрация</h6></td></tr>
<tr><td>Е-майл:</td>
<td colspan="2"><input type="text" id="email"/></td></tr>
<tr><td>Пароль:</td>
<td colspan="2"><input type="password" id="parole"/></td></tr>
<tr><td>Новый?</td>
<td width="10"><input type="checkbox" id="isreg" onchange="document.getElementById( 'button' ).value='Регистрация'"/></td>
